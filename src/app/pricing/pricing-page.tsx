...
export const metadata = {
  ...
  description: 'Deep-dive school research reports and transfer playbooks. Full Access $24.99, one-time payment.',
}
        ...
        <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col">
            ...
            <div className="flex items-baseline gap-1 mb-1">
              <span className="font-serif text-4xl text-charcoal">$24.99</span>
            </div>
        ...
        <div className="max-w-2xl mx-auto mt-16">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-200">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ['Cost', '$24.99 one-time', '$500 – $2,000', 'Free (your time)'],
